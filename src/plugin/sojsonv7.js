...
// All your existing helper functions like `decodeGlobal`, `cleanSwitchCode1`, `cleanDeadCode`, etc.
// go here, exactly as they were in your original code. I'm omitting them for brevity.

// <--- All original helper functions here, unchanged --->
// ... (Your decodeGlobal, cleanSwitchCode1, cleanSwitchCode2, cleanDeadCode, unlockEnv, purifyCode, etc.)

function decodeGlobal(ast) {
  // Your existing decodeGlobal function code here
  let i = 0;
...
function cleanSwitchCode1(path) {
  // Your existing cleanSwitchCode1 code here
  const node = path.node;
...
function cleanSwitchCode2(path) {
  // Your existing cleanSwitchCode2 code here
  const node = path.node;
...
function removeUniqueCall(path) {
  // Your existing removeUniqueCall code here
...
function unlockDebugger(path) {
  // Your existing unlockDebugger code here
...
function unlockConsole(path) {
  // Your existing unlockConsole code here
...
function unlockLint(path) {
  // Your existing unlockLint code here
...
function unlockDomainLock(path) {
  // Your existing unlockDomainLock code here
  const array_list = [
...
function unlockEnv(ast) {
  // Your existing unlockEnv code here
...
function purifyFunction(path) {
  // Your existing purifyFunction code here
...
function purifyCode(ast) {
  // Your existing purifyCode code here
...
export default function (code) {
  // Step 1: Check if the code has the 'jsjiami.com.v7' signature.
  // This is a simple, effective way to identify the obfuscator.
  if (!code.includes('jsjiami.com.v7')) {
    console.warn('❌ The script does not appear to be obfuscated by jsjiami.com.v7.');
    return code; // Return the original code without making any changes.
  }

  // Step 2: If the signature is found, proceed with the original deobfuscation logic.
